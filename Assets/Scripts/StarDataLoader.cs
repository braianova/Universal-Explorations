...
public class StarDataLoader {
    public class Star {
        ...
        public Color SetColor(byte spectral_type, byte spectral_index) {
            ...
            col[0] = IntColor(0x5c, 0x7c, 0xff); // 01
